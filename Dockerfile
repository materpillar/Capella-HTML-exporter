...
ARG CAPELLA_VER=5.0.0
ARG CAPELLA_TAR=https://download.eclipse.org/capella/core/products/releases/5.0.0-R20201202-123401/capella-5.0.0.202101071610-linux-gtk-x86_64.tar.gz
ARG HTML_EX_ZIP=https://download.eclipse.org/capella/addons/xhtmldocgen/dropins/release/5.0.0/CapellaXHTMLDocGen-5.0.0.202012170838-Capella-5.0.0-dropins.zip
